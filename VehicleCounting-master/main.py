...
class KeyPressHandler(Exception):
    pass

URL = '/home/pi/Desktop/working/VehicleCounting-master/flow.avi'
    ...
    try:
        while True:
            ...
            if not ret:
                ...
                try:
                    c = cv2.waitKey(10)
                    if c == 27 or c == 13 or c == 32:
                        raise KeyPressHandler
                except KeyPressHandler:
                    print "Exit"
                    break
